// (function() {
    ...
    //         console.log("Congrats " + shopper.name + " your original total was $" + shopper.amount.toFixed(2) + ". Your new total is $" + finalAmount.toFixed(2));
    //     } else {
...
//
//
// console.log(makeCar("Dodge", "Challenger"));
...
//
//
// function averageUnitsPerEmployee() {
//     return (numberOfUnitsSold()) / (getEmployee())
// }
//
//
// console.log(averageUnitsPerEmployee());
